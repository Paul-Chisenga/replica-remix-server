          ...
          <div className="row p-12 align-items-center position-relative">
            <div className="col-lg-5 d-flex align-items-center justify-content-md-start justify-content-center">
              <div className="vector-left">
                <img src="/images/bg/topbar-vec-left.png" alt="" />
              </div>
              <div className="welcome-note">
                <p>
                  Welcome To Replica Restaurant!{" "}
                  <Link to="/reservation">For Private Event</Link>
                </p>
              </div>
            </div>
            <div className="col-lg-7 d-flex justify-content-lg-end justify-content-center align-items-center">
              <div className="vector-right">
                <img src="/images/bg/topbar-vec-right.png" alt="" />
              </div>
      ...
      >
        <div className="container-fluid d-flex justify-content-between align-items-center">
          ...
          >
            <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
              <div className="mobile-logo-wrap">
                <Link to="/">
                  <a>
                    <img alt="" src="/images/header2-logo.svg" />
                  </a>
                </Link>
              </div>
              <div
            ...
            <div className="reservation-btn d-lg-none d-flex">
              <Link to="/reservation" className="primary-btn4 btn-md">
                Find Reservation
              </Link>
            </div>
          </div>
          <div className="nav-right d-flex jsutify-content-end align-items-center">
            ...
            <div className="tw-flex tw-items-center md:tw-gap-16">
              <div className="tw-relative mr-2">
                <Link to="/cart">
                  <i className="bi bi-cart tw-text-xl tw-text-black" />
                </Link>
                <span className="tw-absolute -tw-right-2 -tw-top-2 tw-text-amber-700 tw-text-xs tw-font-bold">
                  2
                </span>
              </div>
              <Link to="/reservation">
