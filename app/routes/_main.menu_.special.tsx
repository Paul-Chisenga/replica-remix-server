...
const SpecialMenial = () => {
  return (
    <>
      <Breadcrumb pageName="Special Menu" pageTitle="Special Menu List" />
      <div>
            ...
            <div className="row">
              <div className="col-lg-6 px-0 order-lg-1 order-2">
                <div className="menu-wrapper1 two">
                  <img
                    ...
                    src="/images/icon/menu-top-left.svg"
                    alt="menu-top-left"
                  />
                  <img
                    className="menu-top-right"
                    src="/images/icon/menu-top-right.svg"
                    alt="menu-top-right"
                  />
                  <img
                    className="menu-btm-right"
                    src="/images/icon/menu-btm-right.svg"
                    alt="menu-btm-right"
                  />
                  <img
                    className="menu-btm-left"
                    src="/images/icon/menu-btm-left.svg"
                    alt="menu-btm-left"
                  />
                  ...
                  <div className="menu-list">
                      ...
                      <li>
                        ...
                        <div className="menu-content">
                          <div className="menu-title">
                            <h4>Paneer Butter</h4>
                            <span className="dot">
                              <img src="/images/icon/dot.svg" alt="" />
                            </span>
                    ...
                    <div className="notice-location">
                      ...
                      <p>Address: Parkland,House-167/170, Nairobi, Kenya</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 px-0 order-lg-2 order-1">
                <div className="food-orgin one">
                  ...
                  <img src="/images/icon/food-origin.svg" alt="food-origin" />
                  <h2>Indian Menu</h2>
                  <img src="/images/icon/food-origin.svg" alt="food-origin" />
                </div>
              </div>
        ...
        <div className="menu-divider">
          <img src="/images/icon/sub-title-vec.svg" alt="sub-title-vec" />
          <span />
          <img src="/images/icon/sub-title-vec.svg" alt="sub-title-vec" />
        </div>
                ...
                <div className="menu-wrapper1 two">
                  ...
                  <div className="menu-list">
                    ...
                    <div className="notice-location">
                      ...
                      <p>Address: Nairobi, Kenya. Nairobi, Kenya</p>
                    </div>
                  </div>
                </div>
              </div>
